	...
	<div class="sdtet-entertainment-container sdtet-container">
		...
		<div layout="row" layout-align="center">
			<div class="sdtet-schedule-grid">
			  <div class="sdtet-schedule-title">Main Stage</div>
			  <div class="sdtet-schedule-date">FRIDAY 02.16.18</div>
			  <div class="sdtet-schedule-title">Cultural Village</div>
			  ...
			  <div class="sdtet-schedule-main-stage">Tammy Pham</div>
			  <div class="sdtet-schedule-date">5:30 PM</div>
			  <div class="sdtet-schedule-cultural-village">Legendary Lion Dance</div>

			  <div class="sdtet-schedule-main-stage">Pageant Fashion Show</div>
			  <div class="sdtet-schedule-date">6:30 PM</div>
			  <div class="sdtet-schedule-cultural-village"></div>

			  <div class="sdtet-schedule-main-stage">B-Boy Battle Break Dance Contest</div>
			  <div class="sdtet-schedule-date">7:00 PM</div>
			  <div class="sdtet-schedule-cultural-village">Traditional Singers</div>

			  <div class="sdtet-schedule-main-stage">Hoang Thanh</div>
			  <div class="sdtet-schedule-date">8:00 PM</div>
			  <div class="sdtet-schedule-cultural-village">Festival Opens</div>

			  <div class="sdtet-schedule-main-stage">Step Up Dance</div>
			  <div class="sdtet-schedule-date">8:30 PM</div>
			  <div class="sdtet-schedule-cultural-village"></div>

			  <div class="sdtet-schedule-main-stage">Step Up Dance winners</div>
