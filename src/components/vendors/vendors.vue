	...
	<div class="sdtet-container">
		...
		<div class="sdtet-vendors-container">
			...
			<div class="sdtet-vendors-instructions-container">
				...
				<p>
					<b>Food</b> Vendor Application
					<a target="_blank" href="download/Tet 2018 Food.pdf">download</a>
				</p>
				<p>
					<b>Non-Food</b> Vendor Application :
					<a target="_blank" href="download/Tet 2018 Non-Food.pdf">download</a>
				</p>
				<br>
				<br>
				<h4>
